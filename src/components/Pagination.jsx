...
export default class Pagination extends Component {
  ...
  getPageNumber() {
    const pagesInTotal = Math.ceil(
      this.props.data.length / this.props.dataInOnePage
    )
  ...
  gotoPage(page) {
    ...
    const currentPage = Math.max(
      ...
      Math.min(
        page,
        Math.ceil(this.props.data.length / this.props.dataInOnePage)
      )
    )
          ...
          <ul>
            {pages.map((page, index) => {
              if (page === 'LEFT')
                return (
                  <li key={index} className="page-item">
                    <a href="#" className="page-link" onClick={this.moveLeft}>
              ...
              if (page === 'RIGHT')
                return (
                  <li key={index} className="page-item">
                    <a href="#" className="page-link" onClick={this.moveRight}>
